...
Location::Location(std::ifstream &file, int *i, std::vector<std::string> loc) : _httpMethodsSet(false),
																_cgiSet(false), _errorLoc(false) {
	this->functPtr[0] = &Location::setHttpMethods;
